...
ggplot(data = surveys,
  ...
  geom_jitter() +
  facet_wrap(~species) +
  labs(title = "Weight vs. Hindfoot Length in Species",
       x = "Weight (g)",
...
Based on the results of the ANOVA F-test, I have significant evidence to conclude that at least one species' mean weight is different from all or another species mean weight. The F-statistic of nearly 20000 corresponds to a p-value of near 0.
